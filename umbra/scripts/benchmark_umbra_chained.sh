...
# Difference with umbra-default: chained hash table
# export UMBRA_ENGINE_HASHTABLE_IMPLEMENTATION=c  instead of 'a'

mv results/benchmark_umbra_chained.csv results/benchmark_umbra_chained.csv.old
mkdir -p results/
...
# hash table mode 
export UMBRA_ENGINE_HASHTABLE_IMPLEMENTATION=c # (The default hash table mode (Auto:'a' (default), Chaining:'c', RobinHood:'r'))
...
bin/sql "" empty.sql scripts/benchmark_umbra_chained.sql
