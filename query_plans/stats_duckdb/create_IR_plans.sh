...
aliases_map="../../benchmarks/stats-ceb/preprocessed_queries/aliases_map.json" # alias -> relation_name mapping
...
# Query 28 contains an invalid filter condition that is not detected by the script that converts the plans to IR format.
